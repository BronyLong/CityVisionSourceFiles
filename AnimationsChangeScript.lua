...
local animNames = { 
	...
	walk = 	{ 	
				{ id = "http://www.roblox.com/asset/?id=5165738906", weight = 10 } -- Paste your id where is says YourID
			}, 
	run = 	{
				{ id = "http://www.roblox.com/asset/?id=5165738906", weight = 10 } -- Paste your id here as well so it can work 
			}, 
	swim = 	{
